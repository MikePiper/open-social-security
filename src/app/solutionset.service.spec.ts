...
//Test generateSingleSolutionSet
  ...
  it('SolutionSet object should have appropriate date saved as earliest date', () => {
    ...
    personA.retirementBenefitDate = new MonthYearDate(2027, 5, 1) //no particular reason for any of these dates
    personB.retirementBenefitDate = new MonthYearDate(2026, 5, 1)

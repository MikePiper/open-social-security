...
describe('PresentValueService Single', () => {
  ...
  it('should be created', inject([PresentValueService], (service: PresentValueService) => {
    ...
    it('should return appropriate PV for single person, adult disabled child, earnings test applicable, future benefit cut assumption', inject([PresentValueService], (service: PresentValueService) => {
      let scenario:CalculationScenario = new CalculationScenario
...
describe('PresentValueService Couple', () => {
  ...
  //Test calculateCouplePVmonthlyLoop
  ...
  fit('should return appropriate PV for married couple, basic inputs, one filing early one late', inject([PresentValueService], (service: PresentValueService) => { 
    let personA:Person = new Person("A")
    let personB:Person = new Person("B")
    let scenario:CalculationScenario = new CalculationScenario()
    scenario.maritalStatus = "married"

...
//This is just variables/fields that don't fit under Person object or under CalculationYear object (i.e., things that don't get reset each year, but which don't belong to a Person object)
    ...
    // saving extra value here for cut/nocut PV calculation
    ...
    pvNoCut: number;
    earlySpousalBenefitPossible: boolean = false; // true if, for a given couple, a person may claim their spousal benefit before their own benefit

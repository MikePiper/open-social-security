...
export type mortalityTableOption = "fixed" | "NS1" | "NS2" | "SSA" | "SSA2016" | "SSA2017" | "SSA2019" | "SSA2020" | "SSA2021" | "SSA2022" | "SM1" | "SM2"
...
export class MortalityService {
  ...
  determineMortalityTable (gender:string, mortalityInput:mortalityTableOption, assumedDeathAge:number) {
    ...
    if (gender == "male") {
      ...
      if (mortalityInput === "SSA2021") {mortalityTable = this.male2021SSAtable}
      if (mortalityInput === "SSA2022") {mortalityTable = this.male2022SSAtable}
    ...
    if (gender == "female") {
      ...
      if (mortalityInput === "SSA2021") {mortalityTable = this.female2021SSAtable}
      if (mortalityInput === "SSA2022") {mortalityTable = this.female2022SSAtable}
...
//Lives remaining out of 100k, from SSA 2022 period life table
...
//Lives remaining out of 100k, from SSA 2021 period life table
// from https://www.ssa.gov/oact/STATS/table4c6.html
male2021SSAtable = [
  100000,
  99414,

...
describe('BirthdayService', () => {
  ...
  //testing findSSbirthdate
      it('should determine correct DoB with mid-month birthday', inject([BirthdayService], (service: BirthdayService) => { 
        let correctDoB:Date = new Date(1956, 2, 1)  //correct SSbirthday is March 1, 1956
      ...
      it('should determine correct DoB with 1st of month birthday', inject([BirthdayService], (service: BirthdayService) => { 
        let correctDoB:Date = new Date(1956, 2, 1) //correct SSbirthday is March 1 1956, given first of month DoB
      ...
      it('should determine correct DoB with Jan 1 birthday', inject([BirthdayService], (service: BirthdayService) => { 
        let correctDoB:Date = new Date(1956, 11, 1) //correct SSbirthday is Dec 1 1956, given January 1 1957 DoB
    ...
    it('should determine correct FRA with mid-month birthday', inject([BirthdayService], (service: BirthdayService) => { 
      let SSbirthDate:Date = new Date (1956, 2, 1) //user inputs 3/25/1956 
      let correctFRA:Date = new Date(2022, 6, 1)  //correct FRA is July 1, 2022 (FRA of 66 and 4 months given 1956 DoB)
    ...
    it('should determine correct FRA with 1st of month birthday', inject([BirthdayService], (service: BirthdayService) => { 
      let SSbirthDate:Date = new Date (1960, 2, 1) //user inputs 4/1/1960 
      let correctFRA:Date = new Date(2027, 2, 1) //correct FRA is March 1, 2027 (FRA of 67 given 1960 DoB)
      expect(service.findFRA(SSbirthDate)) 
          .toEqual(correctFRA)
    }))

    it('should determine correct FRA with Jan 1 birthday', inject([BirthdayService], (service: BirthdayService) => { 
      let SSbirthDate:Date = new Date (1957, 11, 1) //user inputs 1/1/1958 
      let correctFRA:Date = new Date(2024, 5, 1) //correct FRA is June 1, 2024 (FRA of 66 and 6 months given 1957 SSbirthday)
      expect(service.findFRA(SSbirthDate)) 
          .toEqual(correctFRA)
    }))
